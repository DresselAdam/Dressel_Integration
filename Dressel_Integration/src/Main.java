...
>>>>>>> branch 'master' of https://github.com/Slimes3/Dressel_Integration
     ...
     */
    /*
     * Casting variables is used to convert variable types. This is useful performing operations
     * with two different variable types, such as an int and a double.
     */
    final int FEE = (int) 1;
...
>>>>>>> branch 'master' of https://github.com/Slimes3/Dressel_Integration
    ...
    /*
     * A do/while loop is used so that the messages will replay if the user enters an invalid option
     * or input. At the end of each branch the keepLoop value is set to the corresponding value.
     */
    /*
     * User enters branch where they can either deposit or withdrawal money from current balance.
     */
    do {
